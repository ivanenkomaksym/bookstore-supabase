...
namespace WebUI.Services
{
    public interface IDatabaseService
    {
        ...
        public Task Delete<TModel>(Expression<Func<TModel, bool>> predicate) where TModel : BaseModel, new();
        ...
        public Task<List<TModel>?> InsertMany<TModel>(ICollection<TModel> item) where TModel : BaseModel, new();
